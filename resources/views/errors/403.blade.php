...
<head>
    ...
    <title>403 - Forbidden | {{ config('app.name', 'DentalCare') }}</title>
...
<body class="h-full font-sans antialiased text-slate-100 bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-teal-500/10 blur-[140px] rounded-full pointer-events-none"></div>
    ...
    <div class="max-w-md w-full bg-slate-900/90 border border-slate-800 backdrop-blur-2xl rounded-3xl p-8 sm:p-10 shadow-2xl relative z-10 text-center space-y-6">
        ...
        <div class="space-y-2">
            <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-white">Access Forbidden</h1>
